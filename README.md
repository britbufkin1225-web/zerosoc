...
ZeroSOC is currently in active development. The backend foundation is functional and tested. The next major focus is building a simple dashboard so the project becomes easier to demonstrate visually.